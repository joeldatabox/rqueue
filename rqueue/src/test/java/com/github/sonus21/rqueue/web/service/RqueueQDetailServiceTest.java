...
public class RqueueQDetailServiceTest {
  ...
  public void getQueueDataStructureDetail() {
    ...
    assertEquals(metaData, rqueueQDetailService.getQueueDataStructureDetail(queueConfig));
  }
  ...
  public void getQueueDataStructureDetails() {
    ...
    List<Entry<NavTab, RedisDataDetail>> metaData2 = new ArrayList<>();
    metaData2.add(
    ...
    map.put("test", metaData);
    map.put("test2", metaData2);
  ...
  public void getNavTabs() {
    ...
    assertEquals(navTabs, rqueueQDetailService.getNavTabs(queueConfig2));
    navTabs.add(1, NavTab.SCHEDULED);
  ...
  public void getScheduledTasks() {
    ...
    queueConfigList.add(queueConfig2);
    ...
    doReturn(Collections.singletonList(100L))
        .when(redisTemplate)
